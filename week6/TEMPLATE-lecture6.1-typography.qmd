...
font_add_google(name = "Josefin Sans", #exactly as it says on Google w/ spacing and capitalization
                family = "josefin") #what you will refer to it as
...
showtext.auto() #must turn showtext on 
...
final_plot <- ggplot(subset_jobs) +
  ...
  theme(
    plot.title.position = "plot", #moves titles over to left hand side 
    plot.title = element_text(family = "josefin", #add the Google font
                              face = "bold",
                              size = 18, 
                              color = earnings_pal["dark_text"]),
    plot.subtitle = ggtext::element_textbox(family = "sen", #use element_textbox!!!!!!
                                 size = 11.5,
                                 color = earnings_pal["light_text"],
                                 margin = margin(t = 2, r = 0, b = 6, l = 0)), #adds breathing room 
    plot.caption = ggtext::element_textbox(family = "sen", 
                                face = "italic", #data source on bottom rigth
                                color = earnings_pal["light_text"],
                                margin = margin(t = 15),
                                halign = 1, 
                                lineheight = 1.5),
    strip.text = element_text(family = "josefin", 
                              face = "bold", #titles of each facet panel 
                              size = 10, 
                              hjust = 0),
    panel.spacing.y = unit(0.5, "cm"), #spacing around panels
